            ...
            SingleChildScrollView(
              child: Column(
                children: [
                        ...
                        Column(
                          children: [
                            IconButton(
                              ...
                              icon: Image.asset('assets/images/wash-fold.png',scale: 14,),
                              iconSize: 20,
                            ),
                        ...
                        Column(
                          children: [
                            IconButton(
                              ...
                              icon: Image.asset('assets/images/ironing.png',scale: 14,),
                              iconSize: 48,
                            ),
                        ...
                        Column(
                          children: [
                            IconButton(
                              ...
                              icon: Image.asset('assets/images/dry-cleaning.png',scale: 14,),
                            ),
                  ...
                  const Padding(
                    padding: EdgeInsets.only(top: 15.0,bottom: 0,left: 12),
                    child: Align(
                      alignment: Alignment.center,
                      child: Text(
                        "ECONOMICAL SERVICES",
                          ...
                          Column(
                            children: [
                              IconButton(
                                ...
                                icon: Image.asset('assets/images/premium.png',scale: 14,),
                                iconSize: 50,
                              ),
                          ...
                          Column(
                            children: [
                              IconButton(
                                ...
                                icon: Image.asset('assets/images/steam-iron.png',scale: 14,),
                              ),
                          ...
                          Column(
                            children: [
                              IconButton(
                                ...
                                icon: Image.asset('assets/images/car.png',scale: 14,),
                                iconSize: 48,
                              ),
                              const Text('Car Wash'),
                            ],
                          ...
                          Column(
                            children: [
                              IconButton(
                                ...
                                icon:
                                Image.asset('assets/images/shoes-cleaning.png',scale: 14,),
                              ),
                          ...
                          Column(
                            children: [
                              IconButton(
                                ...
                                icon: Image.asset('assets/images/bag.png',scale: 14,),
                              ),
                              const Text('Toy Wash'),
                            ],
                          ),
                          Column(
                            children: [
                              IconButton(
                                ...
                                icon: Image.asset('assets/images/shirt.png',scale: 14,),
                              ),
                              const Text('Spotting'),
                            ],
                          ),
